...
#ifndef _KDEBUG_H_
#define _KDEBUG_H_ "$Id: kdebug.h,v 1.2.2.2 2002/12/13 14:10:51 hausmann Exp $"
...
// no linefeed -> qDebug already adds it
inline kdbgstream &endl( kdbgstream &s) { s.flush(); return s; }
...
inline kndbgstream kdWarning(int = 0) { return kndbgstream(); }
inline kndbgstream kdWarning(bool , int = 0) { return kndbgstream(); }
inline kndbgstream kdError(int = 0) { return kndbgstream(); }
inline kndbgstream kdError(bool , int = 0) { return kndbgstream(); }
inline kndbgstream kdFatal(int = 0) { return kndbgstream(); }
